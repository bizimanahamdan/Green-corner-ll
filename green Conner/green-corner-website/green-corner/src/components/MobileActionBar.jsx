    ...
    >
      <div className={`grid ${cols === 3 ? "grid-cols-3" : cols === 2 ? "grid-cols-2" : "grid-cols-1"}`}>
        {hasPhone && (
          <a
            href={phoneHref}
            className="flex flex-col items-center justify-center gap-0.5 py-2.5 text-ink-700 active:bg-ink-900/5 min-h-[56px]"
          >
        ...
        {hasWhatsApp && (
          <button
            onClick={openModal}
            className="flex flex-col items-center justify-center gap-0.5 py-2.5 text-leaf-600 border-x border-ink-900/10 active:bg-leaf-50 min-h-[56px]"
          >
        ...
        {count > 0 ? (
          ...
          >
            <span className="relative">
              ...
              <span className="absolute -top-2 -right-3 rounded-full bg-citrus-500 px-1 text-[10px] font-bold text-ink-900">
                {count}
              </span>
            </span>

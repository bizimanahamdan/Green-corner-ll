...
export default function WhatsAppButton() {
  ...
  const b = info || demo;
  const message = encodeURIComponent(`Hi ${b.name}! I'd like to ask about an order.`);
  return (
    <a
      href={`https://wa.me/${b.whatsapp}?text=${message}`}
      target="_blank"
      rel="noreferrer"
      aria-label={`Message ${b.name} on WhatsApp`}
